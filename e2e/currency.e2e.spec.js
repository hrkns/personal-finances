...
test("currency CRUD flow works end-to-end", async ({ page }) => {
  ...
  await expect(page.locator("#currency-submit-button")).toHaveText("Update");
  ...
  await expect(page.locator("#currency-form-message")).toHaveText("Currency updated");
  ...
  await expect(page.locator("#currency-form-message")).toHaveText("Currency deleted");
